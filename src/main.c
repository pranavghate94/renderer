...
void update(void) {
    ...
    for(int i = 0; i < num_faces; i++) {
        ...
        // Calculate the average depth for each face based on the vertices after transformation (Hacky)
    ...
    // Sort the triangles to render by their avg_depth using bubblesort
